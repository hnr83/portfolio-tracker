  ...
  return <div className="space-y-4 sm:space-y-5">
    ...
    <div className="rounded-[22px] border border-slate-800/80 bg-slate-950/70 p-4 sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div><h2 className="text-lg font-semibold text-white">Evolución en tu cartera</h2><p className="mt-1 text-xs text-slate-400">Valor, unidades acumuladas y peso histórico</p></div>
      ...
      <div className="mt-5 h-[310px] w-full">
        <ResponsiveContainer width="100%" height="100%"><AreaChart data={rows} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
          ...
          <Tooltip contentStyle={{ background: "#020617", border: "1px solid #334155", borderRadius: 14 }} formatter={(v) => chartMetric === "market_value_usd" ? formatCurrency(v, "USD") : chartMetric === "portfolio_weight_pct" ? formatPortfolioPercent(v) : formatNumber(v, 6)}/>
